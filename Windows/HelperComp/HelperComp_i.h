...
EXTERN_C const IID IID_IHelper;
    ...
    public:
        ...
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE SendPath2( 
            /* [in] */ BSTR path,
            /* [in] */ BSTR patterns) = 0;
    ...
    typedef struct IHelperVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *SendPath2 )( 
            IHelper * This,
            /* [in] */ BSTR path,
            /* [in] */ BSTR patterns);
...
#define IHelper_SendPath2(This,path,patterns)	\
    ( (This)->lpVtbl -> SendPath2(This,path,patterns) ) 

#define IHelper_run(This,path)	\
    ( (This)->lpVtbl -> run(This,path) ) 
